...
export default function RegisterForm() {
  ...
  return (
    <form
      className="m-5 flex flex-col items-center justify-center gap-30 p-5"
      onSubmit={(e) => {
        e.preventDefault();
        sendData();
      }}
    >
      ...
      <button
        type="submit"
        className="m-5 rounded border-3 border-slate-700 bg-white p-5 pr-10 pl-10 text-xl text-slate-700 shadow-xl transition-all duration-300 hover:scale-110 hover:cursor-pointer hover:bg-slate-700 hover:text-white active:scale-125"
      >
        Register
      </button>
    </form>
